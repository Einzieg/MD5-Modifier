...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-pink-500 to-rose-500 text-white shadow-lg hover:shadow-pink-500/30 hover:-translate-y-0.5",
    secondary: "bg-white text-gray-800 shadow-md hover:shadow-lg border border-gray-100 hover:bg-gray-50",
